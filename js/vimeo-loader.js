let LiteVimeoEmbed=(()=>{class LiteVimeoEmbed extends HTMLElement{constructor(){super();this.iframeLoaded=false;this.setupDom();}
...
set background(value){if(value){this.setAttribute('background','background');}
...
break;}
default:break;}}
addIframe(){if(!this.iframeLoaded){let apValue=((this.autoLoad&&this.background)||(!this.autoLoad))?"background=1":"";let srcUrl=new URL(`/video/${this.videoId}?${apValue}&#t=${this.videoStartAt}`,"https://player.vimeo.com/");const iframeHTML=`
...
LiteVimeoEmbed.preconnected=false;return LiteVimeoEmbed;})();export{LiteVimeoEmbed};customElements.define('lite-vimeo',LiteVimeoEmbed);